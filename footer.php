 ...
 */
				...
				<footer id="real-footer" role="contentinfo" class="row-fluid" style="max-width: 1200px !important; margin: 0 auto;">
					<?php tha_footer_top(); ?>
					<div class="12">
						<div style="font-size: 0.8em;" id="site-generator"<?php echo has_nav_menu('footer-menu') ? ' class="footer-nav-menu"' : ''; ?>>
